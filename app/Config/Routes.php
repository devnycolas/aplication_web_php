...
$routes->post('/login/autenticar', 'Login::autenticar', ['as' => 'login.autenticar', 'filter' => 'csrf']);
$routes->get('/login/sair', 'Login::sair', ['as' => 'login.sair']);

// Register Routes
$routes->get('/register', 'Register::index', ['as' => 'register']);
$routes->post('/register/autenticar', 'Register::autenticar', ['as' => 'register.autenticar', 'filter' => 'csrf']);

// Recover Password Routes
$routes->get('/forgot/password', 'Forgot::index', ['as' => 'forgot']);
$routes->post('/forgot', 'Forgot::store', ['as' => 'forgot.store', 'filter' => 'csrf']);
$routes->get('/reset/(:any)', 'Forgot::edit/$1', ['as' => 'forgot.edit']);
$routes->post('/forgot/update/(:any)', 'Forgot::update/$1', ['as' => 'forgot.update', 'filter' => 'csrf']);
